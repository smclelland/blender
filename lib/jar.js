...
(function() {
  var Jar, ScriptNode, StyleNode, async, bower, crypto, death, fs, jam, nib, path, stylus, uglify, zlib;
  ...
  jam.ls('./', function(err, output, packages) {
  ...
  module.exports = Jar = (function() {
        ...
        function(callback) {
          ...
          if (_this.production) {
            if (_this.options["package"]) {
              ...
              _this.buildProductionScript(_this.vendorDependencies, "" + _this.name + "_vendor", false);
    ...
    */
    ...
    Jar.prototype.resolveBowerDependencies = function(vendors) {
      var bowerDir, resolve, results, rootComponentJson;
      results = {};
    ...
    */
    ...
    Jar.prototype.addVendorDependencies = function(vendors, callback) {
      var bd, bowerComponent, bowerDependencies, componentName, depName, isJs, isRemote, modularize, name, node, parentIndex, pathName, vendorPath, vendorRootPath, _i, _j, _len, _len1, _ref;
      bowerDependencies = this.resolveBowerDependencies(vendors);
      for (name in bowerDependencies) {
        bd = bowerDependencies[name];
        _ref = bd.dependencies;
        for (_i = 0, _len = _ref.length; _i < _len; _i++) {
          depName = _ref[_i];
      ...
      for (_j = 0, _len1 = vendors.length; _j < _len1; _j++) {
        ...
        if (!isJs && !isRemote) {
          ...
          if (!bowerComponent) {
            throw "Could not resolve bower component path: " + componentName;
          }
