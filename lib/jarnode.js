...
(function() {
  var JarNode, ScriptNode, Sync, coffeeScript, death, fs, handlebars, nib, path, stylus,
  ...
  module.exports.StyleNode = ScriptNode = (function(_super) {
    ...
    */
    ...
    function ScriptNode(pathName, rootPath, remote) {
      var ext, file, _ref;
    ...
    */
    ...
    ScriptNode.prototype.compileStylusSync = function() {
      var _this = this;
      return Sync(function() {
        return _this.compileStylus.sync();
      }, function(err) {
        if (err) {
          return death(err.message);
        }
      });
    };
    ...
    */
    ...
    ScriptNode.prototype.compileStylus = function(callback) {
      var _this = this;
    ...
    */
    ...
    ScriptNode.prototype.resolveFileDependency = function(requirePath) {
      if (fs.existsSync(requirePath)) {
        ...
        return death("Can not resolve require dependency in: [" + requirePath + "]");
      }
    };
