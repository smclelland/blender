  ...
  Blender = (function() {
    ...
    */
    ...
    Blender.prototype.init = function(options) {
      ...
      if (options.common.url_root == null) {
        options.common.url_root = '/blender';
      }
      for (name in options) {
        ...
        this.jars[name] = jar = new Jar(name, this.emitter, options.common.url_root, this.production, jarOptions);
        jar.build();
      }
      return this.rebuildUrlIndex();
    };
    ...
    */
    ...
    Blender.prototype.middleWare = function(req, res, next) {
      ...
      urlRoot = this.options.common.url_root;
